...
#
# # Создайте функцию-декоратор print_args, которая распечатывает аргументы *args
# # и **kwargs функции, которую она декорирует
# #
...
#
# ##################################
# # 71. Тестирование скорости
# #################################
# print(termcolor.colored('\n71. Тестирование скорости', 'red'))
#
# # start_time = time.time()
# # sum([number for number in range(100000000)])
# # end_time = time.time() - start_timet
# #
# # art_time = time.time()
# # sum((number for number in range(100000000)))
...
#
# ##################################
# # 72. Проверка аргументов
# #################################
# print(termcolor.colored('\n72. Проверка аргументов', 'red'))
#
# from functools import wraps
#
#
# def prohibit_kwrgs(func):
#     @wraps(func)
#     def wrapper(*args, **kwargs):
#         if kwargs:
...
# def print_hello(name, last_name):
#     print(f'Hello {name}, {last_name}')
#
# print_hello('Jack', 'Greek')
...
#
# ##################################
# # 73. Декораторы с аргументами
# #################################
# print(termcolor.colored('\n73. Декораторы с аргументами', 'red'))
#
# from functools import wraps
#
# def check_if_first_srg_is(value):
#     def inner_dec(func):
#         @wraps(func)
#         def wrapper(*args, **kwargs):
...
#     return inner_dec
#
# @check_if_first_srg_is('orange')
# def print_rainbow_colors(*colors):
#     print(colors)
#
# @check_if_first_srg_is(7)
# def multiply_7(a, b):
#     return a * b
#
...
#     print('You can make dngerous things')
#
# #password_1 = input('input passwrod')
#
...
# #################################
# print(termcolor.colored('\n75. unittest', 'red'))
# # file upper.py and test_upper.py
#
#
# ##################################
# # 76. Test Driven Development (TDD)
# #################################
# print(termcolor.colored('\n76. Test Driven Development (TDD)', 'red'))
# # file cool_game.py and test_cool_game.py
#
#
# ##################################
# # 77. Методы unittest
# #################################
# print(termcolor.colored('\n77. Методы unittest', 'red'))
# # file cool_game.py and test_cool_game.py
#
#
#
...
# # 79. Что такое HTTP
# #################################
# print(termcolor.colored('\n79. Что такое HTTP', 'red'))
#
# ##################################
# # 80. Модуль requests
# #################################
# print(termcolor.colored('\n80. Модуль requests', 'red'))
#
# import requests
#
...
# # 81. Что такое API
# # ################################
# print(termcolor.colored('\n81. Что такое API', 'red'))
#
#
# https://earthquake.usgs.gov/fdsnws/event/1/
# https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&latitude=43.11&longitude=131.87&maxradiuskm=1000
#
#
# # #################################
# # 82. Работа с API
...
#         'maxradiuskm': '1000'
#     })
# # print(response.text) # получаем STR
# # print(response.json())
# # print(type(response.json()))  # в таком случае сразу получаем тип DICT
#
# data = response.json()
#
# # print(data['features'][0]['properties']['place'])
# # print(data['features'][1]['properties']['place'])
# # print(data['features'][2]['properties']['place'])
#
#
# for count, value in enumerate(data['features']):
#     print(str(count) + '. Place: ' + str(data['features'][count]['properties']['place']) + '. Magnitude: ' + str(data['features'][count]['properties']['mag']))
#
#
# # #################################
# # 87. BeautifulSoup
# # ################################
# # print(termcolor.colored('\n87. BeautifulSoup', 'red'))
#
...
# # html_elem = parsed_html.select("li")[2]
# # print(html_elem.getText())
#
# green_elem_list = parsed_html.select(".green")
# # for html_elem in green_elem_list:
# #     print(html_elem.getText())
...
# #################################
# 89. Извлечение данных иерархически
# ################################
print(termcolor.colored('\n89. Извлечение данных иерархически', 'red'))
...
# data = parsed_html.body.ol.contents
# data = parsed_html.body.ol.contents[3]
# data = parsed_html.body.contents[7].contents
# data = parsed_html.body.contents[7].contents[1]
